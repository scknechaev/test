        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            year: function year(unixDate) {
              ...
              var activeYear = ngModelController.$modelValue ? moment.utc(ngModelController.$modelValue).year() : 0;
            ...
            month: function month(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment.utc(ngModelController.$modelValue).format('YYYY-MMM') : 0;
            ...
            day: function day(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment.utc(ngModelController.$modelValue).format('YYYY-MMM-DD') : '';
            ...
            hour: function hour(unixDate) {
              ...
              var activeFormat = ngModelController.$modelValue ? moment.utc(ngModelController.$modelValue).format('YYYY-MM-DD H') : '';
            ...
            minute: function minute(unixDate) {
              ...
              var activeFormat = ngModelController.$modelValue ? moment.utc(ngModelController.$modelValue).format('YYYY-MM-DD H:mm') : '';
          ...
          var getUTCTime = function getUTCTime(modelValue) {
            var tempDate = (modelValue ? moment.utc(modelValue).toDate() : new Date());
